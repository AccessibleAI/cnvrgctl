...
type CnvrgAppSpec struct {
	...
	Minio struct {
		...
		CPURequest    interface{}    `json:"cpuRequest"`
	...
	Pg struct {
		...
		FsGroup        interface{}    `json:"fsGroup"`
		StorageClass   string `json:"storageClass"`
		CPURequest     interface{}    `json:"cpuRequest"`
		MemoryRequest  string `json:"memoryRequest"`
		MaxConnections interface{}    `json:"maxConnections"`
	...
	CnvrgApp struct {
		...
		InitialDelaySeconds     interface{}    `json:"initialDelaySeconds"`
		ReadinessPeriodSeconds  interface{}    `json:"readinessPeriodSeconds"`
		ReadinessTimeoutSeconds interface{}    `json:"readinessTimeoutSeconds"`
		FailureThreshold        interface{}    `json:"failureThreshold"`
